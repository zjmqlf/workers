...
export const onRequest: PagesFunction<PagesEnv> = async ({ request, env, params }) => {
  ...
  const envString = {
    ...
    "2": env.amumujiema_WebSocketServer,
    "3": env.fileport_WebSocketServer,
    "4": env.xiumi_WebSocketServer,
    "5": env.zyxfiles_WebSocketServer,
    "6": env.kodexfiles2_WebSocketServer,
    "7": env.ryumasepongmilku_WebSocketServer,
    "8": env.lunindiacipoksupretto_WebSocketServer,
    "9": env.hijautebal_WebSocketServer,
    "10": env.fileshubro_WebSocketServer,
    "11": env.filespanindo_WebSocketServer,
    "12": env.kodexchatsind_WebSocketServer,
    "13": env.massfilesstore_WebSocketServer,
