...
export const onRequest: PagesFunction<PagesEnv> = async ({ request, env, params }) => {
  ...
  const envString = {
    ...
    "6": env.deanignitenations_WebSocketServer,
    "7": env.kodexfiles2_WebSocketServer,
    "8": env.lunindiacipoksupretto_WebSocketServer,
    "9": env.paniang_WebSocketServer,
    "10": env.ryumasepongmilku_WebSocketServer,
    "11": env.fileshubro_WebSocketServer,
    "12": env.filespanindo_WebSocketServer,
    "13": env.hijautebal_WebSocketServer,
    "14": env.kodexchatsind_WebSocketServer,
