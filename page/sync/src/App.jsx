...
const App = () => {
  ...
  }, [addNewEvent, renderTime, setRowData, setClearGridBtnDisabled, setLogData, setClearLogBtnDisabled, isCompressChecked]);
    ...
    <div style={containerStyle}>
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ width: "100%", height: "5%" }}>
          <label>
            <input type="radio" name="filterType" value="1" checked={documentValue === 0} onChange={handlerRadioChange} />
            图片
          </label>
          <label>
            <input type="radio" name="filterType" value="2" checked={documentValue === 1} onChange={handlerRadioChange} />
            视频
          </label>
