...
DROP TABLE IF EXISTS PANINDEX;
CREATE TABLE IF NOT EXISTS PANINDEX (
  chatId INTEGER NOT NULL,
  txt TEXT NOT NULL
);

CREATE INDEX IF NOT EXISTS idx_panIndex_txt ON PANINDEX(txt);
CREATE INDEX IF NOT EXISTS idx_panIndex_chatId_txt ON PANINDEX(chatId, txt);
