    ...
    if (this.stop === 1) {
      ...
      if (messageLength && messageLength > 0) {
        if (this.stop === 1) {
                ...
                if (messageArray[messageIndex].replyMarkup) {
                    ...
                    for (const row of messageArray[messageIndex].replyMarkup.rows) {
                      if (next === true) {
                        for (const button of row.buttons) {
                          ...
                          //     this.sendMessage("log", "nextStep", "继续推送", null, false);
                          //     await scheduler.wait(10000);
                  ...
                  if (message) {
                    ...
                    if (string[0] === "QQfile_bot") {
                      ...
                      this.sendMessage("log", "nextStep", message, "flood", true);
                      ...
                      if (this.queue === true) {
                        ...
                        await this.ctx.storage.put("queue", false);
                        // console.log("(" + this.currentStep + ") " + message);
                        this.sendMessage("log", "nextStep", message, "error", true);
                      }
          ...
          //     this.sendMessage("log", "nextStep", "自动发送", null, false);
          //     await scheduler.wait(5000);
          //     if (result && result.message) {
          //       this.sendMessage("log", "nextStep", result.message , null, false);
          //     }
      ...
      if (this.toPeer) {
        if (this.stop === 1) {
          ...
          if (messageLength && messageLength > 0) {
                  ...
                  if (messageArray[messageIndex].replyMarkup) {
                      ...
                      for (const row of messageArray[messageIndex].replyMarkup.rows) {
                        if (next === true) {
                          for (const button of row.buttons) {
                            ...
                            //     );
                            //     // console.log("(" + this.currentStep + ") 继续推送");
                            //     this.sendMessage("log", "start", "继续推送", null, false);
                            //     await scheduler.wait(10000);
                            //     if (result && result.message) {
                    ...
                    if (message) {
                      ...
                      if (string[0] === "QQfile_bot") {
                        ...
                        await this.ctx.storage.put("client", this.flood);
                        // console.log("(" + this.currentStep + ") " + message);
                        this.sendMessage("log", "start", message, "flood", true);
                        ...
                        if (this.queue === true) {
                          ...
                          await this.ctx.storage.put("queue", false);
                          // console.log("(" + this.currentStep + ") " + message);
                          this.sendMessage("log", "start", message, "error", true);
                        }
                      } else if (message.includes("您已被限制使用,限制期限为：") === true) {
                        const date = message.replace("您已被限制使用,限制期限为：", "");
                        if (date) {
            ...
            //     );
            //     // console.log("(" + this.currentStep + ") 自动发送");
            //     this.sendMessage("log", "start", "自动发送", null, false);
            //     await scheduler.wait(5000);
            //     if (result && result.message) {
            //       this.sendMessage("log", "start", result.message , null, false);
            //     }
